    ...
    <>
        ...
        <div className="flex relative flex-col gap-12 items-center p-8 pt-28 w-full h-full bg-gradient-to-r lg:px-64 backdrop-blur-[3px] from-[rgba(186,206,74,.9)] to-[rgba(126,217,86,.9)]">
          ...
          >
            <iframe
              width=""
              height=""
              src="https://www.youtube.com/embed/tUt0F3cTT2M?si=jxxkAinvBN14KIX0&autoplay=true"
      ...
      <section className="relative grid-cols-1 gap-4 justify-center items-center py-12 w-screen lg:grid-cols-2 lg:px-64 min-h-[30rem] px-[1rem] bg-[#fafafa]">
        ...
        <div className="hidden flex-col justify-center items-center w-full h-full lg:flex pb-[2rem]">
          <div
            ref={ref}
            className={`w-[40rem] lg:flex hidden h-[40rem] from-[rgba(125,217,86)] to-[#b9fa9e] right-96 top-0 bg-gradient-to-t absolute rounded-md shadow-xl pointer-events-none ${
          ...
          <img
            className="absolute right-[15%] top-[35%] h-[25rem] lg:h-[20rem] z-[99] pointer-events-none"
            src={bonusBadge}
            alt="ebook saladas e molhos"
            style={{ filter: "drop-shadow(0 10px 20px rgba(0,0,0,0.4))" }}
            data-aos="fade-up"
          ...
          />
          <img
            className="absolute top-[10%] right-10 h-[25rem] lg:h-[40rem] pointer-events-none"
            src={BonusEbook1}
            alt="ebook saladas e molhos"
            style={{ filter: "drop-shadow(0 10px 20px rgba(0,0,0,0.4))" }}
            data-aos="fade-up"
